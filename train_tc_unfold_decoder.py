...
class SequenceLightningModule(pl.LightningModule):
    ...
    def setup(self, stage=None):
        ...
        #print("the params config i hope: ",self.hparams) #worked
        ...
        #print("decoder cfg",decoder_cfg) #this needs to edit the seq lenght (should be self.segment_length) and the output dim (should be self.transformer_dim = 40)
