...
class SequenceLightningModule(pl.LightningModule):
    ...
    def setup(self, stage=None):
        ...
        #print("output transform",self.decoder[0].output_transform)
    ...
    def forward(self, batch):
        ...
        #raise Exception("Stop.  hail hydra") ##i might make this a one pass thing in the config.  could be useful.
        #self._state = state
