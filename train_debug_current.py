...
class SequenceLightningModule(pl.LightningModule):
    ...
    def setup(self, stage=None):
        ...
        self.num_classes = 10 #couldn't find this...

        #our model specific hparams:
        self.segment_length = 100 #these should be setup via HYDRA gautam
        self.stride = 100
        self.transformer_dim = 20
        self.transformer_ff_dim = 50
        self.tranformer_num_layers = 1
        ...
        self.transformer_encoder = nn.TransformerEncoder(
            nn.TransformerEncoderLayer(d_model=self.transformer_dim
                                       ...
                                       , dropout=0.1 #default
                                       , batch_first=True)
            , num_layers=self.tranformer_num_layers) #hyperparam gautam
        ...
        ###this i think makes the decoder work with any transform dim!
    ...
    def forward(self, batch):
        ...
        #raise Exception("Stop.  hammertime") ##this is just to stop, for debugging only
        #self._state = state
